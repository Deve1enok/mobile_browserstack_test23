# Проект по автоматизации мобильного тестирования для мобильной версиисайта [Wikipedia](https://ru.wikipedia.org/wiki/)

<img alt="habrCareer" src="media/logo/Wikipedia-logo.png">
...
* <a href="#video">Видеозапись теста с BrowserStack</a>
